    ...
    <footer className="relative bg-black pt-24 pb-4">
      <div className="mx-auto px-6">
        ...
        <div className="mx-auto flex flex-col md:gap-10 lg:gap-80 lg:flex-row lg:items-center">
          ...
          {/* Navigation */}
          <nav className="space-y-3 text-base font-bold text-white lg:text-left">
            {navigationLinks.map((link) => (
              <a
                key={link}
                href="#"
                className="block transition-opacity hover:text-primary"
              >
                {link}
              </a>
            ))}
        ...
        {/* Legal + socials */}
        <div className="mt-12 flex flex-col gap-6 border-t border-white pt-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="mt-24 flex flex-col items-start gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <img src="/logo.svg" alt="MAD Jam Fest" className="h-24 w-auto" />
        </div>
      </div>
    </footer>
  );
